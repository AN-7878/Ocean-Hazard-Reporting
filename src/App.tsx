...
import i18n from "./lang_op"; // make sure you import this
    ...
    <div className={tabContainerClass} style={{ backgroundColor: 'white' }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-6 w-full px-6">
        ...
        <div className="h-[600px] grid grid-rows-4 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-2xl p-6 border-l-4 border-blue-500 
                          transition-transform duration-200 hover:scale-105 hover:shadow-3xl cursor-pointer flex items-center">
          ...
          <button
            className="bg-white rounded-lg shadow-2xl p-6 border-l-4 border-green-500 
                        transition-transform duration-200 hover:scale-105 hover:shadow-3xl cursor-pointer flex items-center w-full text-left"
            onClick={() => setActiveTab('posts')}
          >
          ...
          <button
            className="bg-white rounded-lg shadow-2xl p-6 border-l-4 border-red-500 
                        transition-transform duration-200 hover:scale-105 hover:shadow-3xl cursor-pointer flex items-center w-full text-left"
            onClick={() => setActiveTab('alerts')}
          >
          ...
          <button
            className="bg-white rounded-lg shadow-2xl p-6 border-l-4 border-purple-500 
                        transition-transform duration-200 hover:scale-105 hover:shadow-3xl cursor-pointer flex items-center w-full text-left"
            onClick={() => setActiveTab('shelters')}
          >
